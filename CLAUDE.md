...
- **Categoría en lista Inspección Simple:** tanto `mapCondicionDesdeCaminata` como `mapInspeccionSimple` escriben `Categor_x00ed_a: 'Nuevo Reporte'` siempre. Este valor es el disparador del flujo Power Automate que genera el documento codificado y lo notifica a los líderes. No usar otro valor en estos dos mappers.
