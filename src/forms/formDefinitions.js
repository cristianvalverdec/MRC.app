    ...
    sections: [
      ...
      // ── S2: CONFIGURACIÓN ─────────────────────────────────────────────────
      {
        ...
        questions: [
          ...
          { id: 'Q20', type: 'radio', label: 'Regla de Oro que Verificará — OPERACIONES', required: true,
            visibleWhen: (a) => a.Q18 === 'Área Operaciones Sucursal',
            options: [
              { value: 'N°1 Elementos de Protección Personal (OP)',                                        label: 'N°1 — Elementos de Protección Personal (OP)',                                        style: 'neutral' },
              { value: 'N°2 Transito Interior Frigorífico (OP)',                                          label: 'N°2 — Tránsito Interior Frigorífico (OP)',                                          style: 'neutral' },
              { value: 'N°3 Operación de Equipo Rodante (OP)',                                            label: 'N°3 — Operación de Equipo Rodante (OP)',                                            style: 'neutral' },
              { value: 'N°4 Almacenamiento en Altura (OP)',                                               label: 'N°4 — Almacenamiento en Altura (OP)',                                               style: 'neutral' },
              { value: 'N°5 Carga y Descarga de Camiones (OP)',                                           label: 'N°5 — Carga y Descarga de Camiones (OP)',                                           style: 'neutral' },
              { value: 'N°6 Manejo Manual de Cargas (OP)',                                                label: 'N°6 — Manejo Manual de Cargas (OP)',                                                style: 'neutral' },
              { value: 'N°7 Trabajo Responsable, sin hacer Bromas o Acciones Inseguras (OP)',             label: 'N°7 — Trabajo Responsable, sin Bromas ni Acciones Inseguras (OP)',             style: 'neutral' },
              { value: 'N°8 Mantener un correcto Orden y Aseo en las Instalaciones (OP)',                 label: 'N°8 — Orden y Aseo en las Instalaciones (OP)',                                 style: 'neutral' },
              { value: 'N°9 No interactuar ni intervenir con equipos en movimiento ni automatizados (OP)', label: 'N°9 — No Interactuar con Equipos en Movimiento ni Automatizados (OP)', style: 'neutral' },
              { value: 'N°10 Informar de forma inmediata la ocurrencia de un incidente o accidente (OP)',  label: 'N°10 — Informar Incidentes y Accidentes de Forma Inmediata (OP)',          style: 'neutral' },
            ] },
