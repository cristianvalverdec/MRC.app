...
const modules = [
  {
    ...
    sublabel: 'Seguimiento de exámenes preocupacionales y periódicos',
    accentColor: '#E53E3E',
    soon: true,
  },
  {
    icon: <CalendarClock size={20} color="#fff" />,
    label: 'Ausentismo y Licencias',
    sublabel: 'Registro y análisis de ausentismo laboral',
    accentColor: '#DD6B20',
    soon: true,
  },
  {
    ...
    sublabel: 'Gestión de casos y medidas preventivas',
    accentColor: '#D53F8C',
    soon: true,
  },
  {
    icon: <FileBarChart2 size={20} color="#fff" />,
    label: 'Indicadores de Salud',
    sublabel: 'Dashboard de métricas de salud ocupacional',
    accentColor: '#2F80ED',
    soon: true,
  },
]
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, padding: '24px 16px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{
              ...
              Vigilancia y bienestar de los trabajadores
            </div>
          </div>
        </motion.div>
        ...
        >
          Esta sección está en desarrollo activo. Los módulos de salud ocupacional se habilitarán progresivamente durante los siguientes sprints del proyecto MRC.
        </motion.div>
